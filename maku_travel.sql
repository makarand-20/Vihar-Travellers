...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2022 at 07:14 PM
...
(13, 'Kashmir Vibes', 'Customized', 'Honeymoon', 500, 85847, 'Kulu Manali', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&amp;amp;amp;amp;amp;#039;s standard dummy text ever since the 1500s, when an unknown printer took a. andard dummy text ever since the.', 4, 1, 0),
...
(26, 'Mahima', 'herkarmahima2003@gmail.com', '7894125360', 'Latur', 746586, '2022-12-16', '$2y$10$NosD3DYfYpOscK5MuOSo9eX7MWniUob/L/oKSfwhPwL/kqJADQkh.', 'IMG_61743.jpeg', 1, '1f73627a4e2555a4a20346e7f3c8a161', NULL, 1, '2022-12-27 14:35:52');
...
--
ALTER TABLE `tour_features`
  MODIFY `sr_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=201;
